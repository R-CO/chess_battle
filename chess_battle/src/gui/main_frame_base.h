...
class main_frame_base : public wxFrame 
{
	...
	public:
		...
		main_frame_base( wxWindow* parent, wxWindowID id = wxID_MAIN_FRAME_BASE, const wxString& title = _("Chess Battle 2.0 by R-CO"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 880,650 ), long style = wxCAPTION|wxCLOSE_BOX|wxMINIMIZE_BOX|wxSYSTEM_MENU|wxTAB_TRAVERSAL );
